define(function(require, exports, module){
    ...
    function slotItemMap(){
        var slotItemMap = [
            ...
            {item: 1, weight: 1, value: 1, fruit: 'strawberry'},
            {item: 2, weight: 1, value: 1, fruit: 'pineapple'},
            {item: 3, weight: 1, value: 1, fruit: 'lime'},
            {item: 4, weight: 1, value: 1, fruit: 'avocado'},
